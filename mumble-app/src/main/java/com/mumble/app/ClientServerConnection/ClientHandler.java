...
public class ClientHandler implements Runnable{
        ...
        try{
            ...
            while((msg = in.readLine()) != null){
                ...
                if(msg.split("::")[0].equals("LOGIN")){
                    setUser(new User(msg.split("::")[1], 
                                                        0, 
                                                        DatabaseManager.getUserId(msg.split("::")[1], 
                                                        DatabaseManager.getPassword(msg.split("::")[1]))));
                }
     ...
     * @return the list of connected clients as a List of ClientHandlers
     */
